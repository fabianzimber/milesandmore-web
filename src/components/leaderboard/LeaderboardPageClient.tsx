...
export default function LeaderboardPageClient({
  ...
  return (
    <PageShell tone="night">
      <div className="relative pb-24 pt-28 text-white sm:pt-32 lg:pt-40">
        <header className="page-frame">
          <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_24rem] lg:items-end lg:gap-16">
            <div>
              ...
              <p className="mt-6 text-sm leading-7 text-white/56 sm:text-base sm:leading-8 lg:text-lg">
        ...
        <main className="page-frame space-y-16">
            ...
            {featuredEntries.map((entry, index) => {
              ...
              return (
                <article key={`${entry.user_name}-${index}`} className="surface-gold-accent min-h-[18.5rem] px-7 py-7">
                  ...
                  <p className="mt-9 text-2xl font-black tracking-[-0.04em] text-foreground sm:text-3xl lg:text-4xl">
                    {entry.user_name}
                  </p>
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_22rem]">
            <MotionSection className="surface-glass overflow-hidden p-0" delay={0.04}>
              <div className="flex items-center justify-between border-b border-white/8 px-7 py-5">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-base font-black tracking-tight text-foreground sm:text-lg lg:text-xl">
            ...
            <div className="space-y-8">
              <MotionSection className="surface-glass px-7 py-7" delay={0.08}>
              ...
              <MotionSection className="surface-glass px-7 py-7" delay={0.12}>
...
function Row({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex items-center justify-between gap-4 px-6 py-4 transition-colors hover:bg-white/[0.03]",
    ...
    >
      <div className="flex min-w-0 items-center gap-4">
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs text-white/42">{sublabel}</p>
        </div>
      </div>
