        ...
        {items.map((item) => {
          ...
          return (
              <button
                ...
                className={cn(
                  "relative flex min-w-0 flex-1 items-center justify-center gap-0.5 px-1.5 py-2.5 text-[11px] font-semibold uppercase tracking-[0.12em] transition cursor-pointer sm:gap-2 sm:px-4 sm:py-3 sm:text-sm sm:tracking-[0.16em]",
                  isActive
                    ? tone === "dark"
                      ? "text-foreground"
                    : "text-foreground"
